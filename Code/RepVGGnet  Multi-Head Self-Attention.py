...
hist = model.fit(train_x_reshaped, train_y, epochs=500, batch_size=32, validation_data=(validation_x_reshaped, validation_y),
...
with pd.ExcelWriter('evaluation_metrics4.xlsx', engine='xlsxwriter') as writer:
